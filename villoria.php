   ...
   <body class="font-roboto">
        ...
        <main>
          <section class="py-16 mx-auto text-left hero ">
                <h2 class="xl:text-[40px] lg:text-[30px] text-[20px] px-16 font-light font-anton text-black animate-fade-right animate-once animate-duration-700 animate-ease-linear">JES MARTIN'S</h2>
                <h1 class="xl:text-[160px] lg:text-[120px] text-[60px] px-16 leading-tight font-anton text-black animate-fade-right animate-once animate-duration-700 animate-ease-linear"><span>BATALLITAS</span></h1> 
          </section>
          <nav class="w-full rounded-md bg-white text-black px-16 py-3 mx-auto dark:bg-neutral-600">
                <ol class="list-reset flex">
                    ...
                    <li class="text-neutral-500 dark:text-neutral-300">VILLORIA</li>
                </ol>
            </nav>
          <section class="lg:flex flex-wrap text-black bg-villoria justify-center py-16 px-6">
            <img src="assets/images/VILLORIA.png" class="w-1/2">
           <div class="w-1/2 px-6">
                <h3 class="pt-2 px-8 text-4xl font-bold text-center animate-jump-in animate-once animate-duration-1000 animate-delay-1000 animate-ease-in-out">VILLORIA</h3>
                <div class="text-xl font-semibold text-center ">
                    <p class=" ">Teatro Municipal de la Villa</p>
                    <p class=" ">Domingo, 14 de octubre</p>
